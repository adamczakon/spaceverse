...
import { addTourist, touristAddFlight } from "../../actions/touristActions";
import { getFlights, flightAddTourist } from "../../actions/flightActions";
...
class AddTourist extends Component {
  ...
  setFlightId = (id, e) => {
    e.preventDefault();
    this.setState({ flightId: id, flightActive: id });
  };
  ...
  render() {
    ...
    let flightsList;
    if (this.state.flightsOpen) {
      flightsList = (
        <div className='table-responsive-md'>
          <table className='table mt-3 text-center row-animation'>
            ...
            <tbody>
              {flights.map(flight => (
                <React.Fragment key={flight._id}>
                  {flight.tourists && flight.tourists.length < flight.seats && (
                    <tr
                      className={
                        this.state.flightId === flight._id
                          ? "table-secondary"
                          : undefined
                      }
                      key={flight._id}
                    >
                      ...
                      <td>
                        <button
                          ...
                          onClick={this.setFlightId.bind(this, flight._id)}
                        >
          ...
          <form className='px-4 py-3' onSubmit={this.onSubmit}>
            ...
            <div className='form-row'>
              <div className='form-group col-md-4 '>
                <p className='font-weight-bold my-2'>First Name</p>
                <input
                  type='text'
              ...
              <div className='form-group col-md-4 '>
                <p className='font-weight-bold my-2'>Gender</p>
                <select
                  type='text'
                  className='form-control'
                  name='gender'
            ...
            <div className='form-row'>
              ...
              <div className='form-group col-md-4 '>
                <p className='font-weight-bold my-2'>Birth Date</p>
                <DatePicker
                  className='form-control'
                  type='date'
                  name='birthDate'
            ...
            <div className='form-row'>
              <div className='form-group col-md-9'>
                <p className='font-weight-bold my-2'>Remarks (Optional)</p>
                <textarea
                  className='form-control'
                  name='remarks'
            ...
            <div className='form-row mb-4'>
              <button
                className='btn btn-secondary btn-sm dropdown-toggle ml-1 mt-3'
                onClick={this.toggleFlights}
              >
                Show Avaible Flights {""}
              </button>
            </div>
            {flightsList}
...
export default connect(
  mapStateToProps,
  { addTourist, getFlights, touristAddFlight, flightAddTourist }
)(AddTourist);
